...
const fonts = [
  {
    name: '1. Montserrat (Current)',
    style: { fontFamily: '"Montserrat", sans-serif', fontWeight: 700 },
  },
  {
    name: '2. Oswald (Condensed & Industrial)',
    style: { fontFamily: '"Oswald", sans-serif', fontWeight: 600 },
  },
  {
    name: '3. Space Grotesk (Engineered & Technical)',
    style: { fontFamily: '"Space Grotesk", sans-serif', fontWeight: 700 },
  },
  {
    name: '4. Outfit (Premium & Modern)',
    style: { fontFamily: '"Outfit", sans-serif', fontWeight: 700 },
  },
  {
    name: '5. Roboto Slab (Heavy Steel)',
    style: { fontFamily: '"Roboto Slab", serif', fontWeight: 700 },
  },
  {
    name: '6. Archivo Black (Ultra Solid)',
    style: { fontFamily: '"Archivo Black", sans-serif', fontWeight: 400 },
  },
  {
    name: '7. Bebas Neue (Tall & Imposing)',
    style: { fontFamily: '"Bebas Neue", sans-serif', fontWeight: 400, letterSpacing: '0.05em' },
  },
]
      ...
      <Shell>
        <div className="mb-16">
          ...
          <p className="text-body max-w-xl">
            I have curated a new set of fonts specifically chosen for a pre-engineered building and
            heavy industry group. These are bolder, stronger, and more structural than the previous
            elegant serifs.
          </p>
        </div>
